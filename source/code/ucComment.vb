...
#Region "Data Process"
    Public Sub BuildData()
        For RowIndex As Integer = 0 To vSqlTable.RowCount - 1
            ...
            Dim CommentItem As New ucCommentItem("Tran Van A", "htyh", New Date(2020, 10, 20), 5, IsChild)
            CommentItem.Dock = DockStyle.Fill
            vTableLayoutPanel.RowStyles.Add(New RowStyle(SizeType.AutoSize))
            vTableLayoutPanel.Controls.Add(CommentItem, column:=0, row:=RowIndex)
        Next
    End Sub
